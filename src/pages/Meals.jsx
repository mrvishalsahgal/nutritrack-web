  ...
  return (
    <>
        ...
        {loading ? (
          ...
          <>
            ...
            <div
              onClick={() =>
                alert(
                  "Mock Action: You are now initializing the Custom Recipe Creator.",
                )
              }
            ...
            {meals
              ...
              .map(
                (meal) => (
                  console.log("DASHBOARD MEAL RENDER:", meal),
                  (<SavedMealCard key={meal.id} {...meal} />)
                ),
              )}
      ...
      <div className="mt-16 flex justify-center">
        <button
          onClick={(e) => {
            e.currentTarget.innerText = "No more meals found.";
            e.currentTarget.className =
              "px-8 py-4 bg-transparent text-slate-400 font-semibold rounded-full";
